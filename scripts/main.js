    ...
    var recipes = {
        firstExample: function (element) {
            ...
            var obs = PaintableSet({
                r1c1: new Obstacle(194, 75, 20),
                r1c2: new Obstacle(294, 75, 20),
                r1c3: new Obstacle(394, 75, 20),
                r1c4: new Obstacle(494, 75, 20),
                r2c1: new Obstacle(194, 175, 20),
                r2c2: new Obstacle(294, 175, 20),
                r2c3: new Obstacle(394, 175, 20),
                r2c4: new Obstacle(494, 175, 20),
                r3c1: new Obstacle(194, 275, 20),
                r3c2: new Obstacle(294, 275, 20),
                r3c3: new Obstacle(394, 275, 20),
                r3c4: new Obstacle(494, 275, 20)
            });
        ...
        secondExample: function (element) {
            ...
            var tracks = PaintableSet({
                foo: new Track(obs.topStart, 10),
                bar: new Track(obs.bottomStart, 10)
            });
